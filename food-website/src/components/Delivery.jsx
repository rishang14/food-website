const Delivery = () => {
 return (
  <div className="w-full bg-white py-16 px-4">
    <h3 className="text-orange-500 font-bold text-center text-2xl">Quick Delivery App</h3> 
    <div className="lg:w-[1240px] mx-auto lg:flex flex-row ">
      ...
      <p className="text-[#00df9a] font-bold sm:flex sm:justify-center">Get The App</p> 
      <h1 className="text-2xl md:text-4xl sm:text-3xl py-2 font-bold sm:text-center">Limitless Covenience on-demand</h1> 
      <p  className="flex justify-center items-center sm:text-center " >  Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum
