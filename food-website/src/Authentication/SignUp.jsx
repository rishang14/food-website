              ...
              <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label typeof="terms" className="font-bold text-gray-500">I accept the <a className="font-medium text-primary-600 hover:underline text-orange-700" href="#">Terms and Conditions</a></label>
                      </div>
                  </div>
